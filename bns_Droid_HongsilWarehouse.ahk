...
;================================================================================================================
BnsDroidNavigation_HongsilWarehouse() {
...
BnsDroidAction_HW_AdjustToAlignCenter(){
    ...
    dest:=topBorder-topBorderWhenCenter

    if(dest > 0) {
        DumpLogI("[BnsDroidAction_HW_AdjustToAlignCenter] dest=" dest ", lateral left")
        BnsActionLateralWalkLeft(Abs(dest) * 150)
    }
    else if(dest < 0) {
        DumpLogI("[BnsDroidAction_HW_AdjustToAlignCenter] dest=" dest ", lateral right")
        BnsActionLateralWalkRight(Abs(dest) * 150)
    }
}
...
BnsDroidMission_HW_ClearB3BossRoom(){
    ...
    BnsActionWalk(10500)
    BnsActionWalk(1700)            ;被打到進入戰鬥姿態會降跑速，補償損失時間
...
BnsDroidAction_HW_SearchB3BossRoom() {
    ...
    BnsActionAdjustDirectionOnMap(25)
